...
;
    public static final ResourceLocation CHANNEL_NAME = EchoMining.genRL("main");
    public static final int NETWORK_VERSION = 1;
    public static final String NETWORK_VERSION_STR = String.valueOf(NETWORK_VERSION);
    public static SimpleChannel channel;

    private CemPackets.LoadedPacket<?> packet;

    <T extends SimplePacketBase> CemPackets(Class<T> type, Function<FriendlyByteBuf, T> factory,
