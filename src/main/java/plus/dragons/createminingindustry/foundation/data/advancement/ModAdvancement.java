...
import plus.dragons.createminingindustry.foundation.mixin.CreateAdvancementConstructor;
...
public class ModAdvancement {
    ...
    protected ModAdvancement(String id, Advancement.Builder builder, @Nullable ModAdvancement parent, boolean builtin, String title, String description) {
        this.id = MiningIndustry.genRL(id);
        ...
        this.titleKey = new StringJoiner(".").add("advancement").add(MiningIndustry.MOD_ID).add(id).toString();
    ...
    protected static class Builder {
        ...
        protected Builder(String id) {
            this.id = id;
            this.background = "root".equals(id) ? MiningIndustry.genRL("textures/gui/advancements.png") : null;
        }
